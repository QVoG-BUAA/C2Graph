...
public class WhileStatement extends Statement implements JsonNode {
    private final IASTExpression condition;

    public WhileStatement(IASTExpression condition) {
        super(condition);
    ...
    public String getSignature() {
        return "while " + condition.getRawSignature();
    }
    ...
    public ArrayList<AstBinding> resolveVarRef() {
        ...
        return this.astBindings = ExprUtil.resolveVarRef(this.condition);
    }
